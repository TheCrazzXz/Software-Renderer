...
struct Vec2 Vectors2_add_copy(struct Vec2 vector1, struct Vec2 vector2)
{
	struct Vec2 result = { vector2.x + vector1.x, vector2.y + vector1.y};
	return result;
}
...
struct Vec2 Vectors2_sub_copy(struct Vec2 vector1, struct Vec2 vector2)
{
	struct Vec2 result = { vector1.x - vector2.x, vector1.y - vector2.y};
	return result;
}

struct Vec2 Vectors2_mul(struct Vec2* vector1, struct Vec2* vector2)
{
	struct Vec2 result = { vector1->x * vector2->x, vector1->y * vector2->y};
	return result;
}

struct Vec2 Vectors2_mul_copy(struct Vec2 vector1, struct Vec2 vector2)
{
	struct Vec2 result = { vector1.x * vector2.x, vector1.y * vector2.y};
	return result;
}

struct Vec2 Vectors2_div(struct Vec2* vector1, struct Vec2* vector2)
{
	struct Vec2 result = { vector1->x / vector2->x, vector1->y / vector2->y};
	return result;
}

struct Vec2 Vectors2_div_copy(struct Vec2 vector1, struct Vec2 vector2)
{
	struct Vec2 result = { vector1.x / vector2.x, vector1.y / vector2.y};
	return result;
}
...
struct Vec2 Vec2_addNumber_get_copy(struct Vec2 vector, float number)
{
	struct Vec2 result = { vector.x + number, vector.y + number};
	return result;
}

struct Vec2 Vec2_subNumber_get_copy(struct Vec2 vector, float number)
{
	struct Vec2 result = { vector.x - number, vector.y - number};
	return result;
}
...
bool Vectors2_equals_copy(struct Vec2 vec1, struct Vec2 vec2 )
{
	return vec1.x == vec2.x && vec1.y == vec2.y;
}
...
struct Vec3 Vectors3_add(struct Vec3* vector1, struct Vec3* vector2)
{
	struct Vec3 result = { vector2->x + vector1->x, vector2->y + vector1->y, vector2->z + vector1->z};
	return result;
}

float Vectors3_distance(struct Vec3* vector1, struct Vec3* vector2)
{
	return sqrt(
			(vector1->x - vector2->x) * (vector1->x - vector2->x) /* (deltaX)² */
		+	(vector1->y - vector2->y) * (vector1->y - vector2->y) /* (deltaY)² */	
		+	(vector1->z - vector2->z) * (vector1->z - vector2->z) /* (deltaZ)² */	
	);
}

bool Vectors3_equals(struct Vec3* vec1, struct Vec3* vec2 )
{
	return vec1->x == vec2->x && vec1->y == vec2->y && vec1->z == vec2->z;
}
bool Vectors3_equals_copy(struct Vec3 vec1, struct Vec3 vec2 )
{
	return vec1.x == vec2.x && vec1.y == vec2.y && vec1.z == vec2.z;
}
...
struct Vec4 Vectors4_sub(struct Vec4* vector1, struct Vec4* vector2)
{
	struct Vec4 result = { vector1->x - vector2->x, vector1->y - vector2->y, vector1->z - vector2->z, vector1->w - vector2->w};
	return result;
}

struct Vec4 Vectors4_sub_copy(struct Vec4 vector1, struct Vec4 vector2)
{
	struct Vec4 result = { vector1.x - vector2.x, vector1.y - vector2.y, vector1.z - vector2.z, vector1.w - vector2.w};
	return result;
}

struct Vec4 Vectors4_mul(struct Vec4* vector1, struct Vec4* vector2)
{
	struct Vec4 result = { vector1->x * vector2->x, vector1->y * vector2->y, vector1->z * vector2->z, vector1->w * vector2->w};
	return result;
}

struct Vec4 Vectors4_mul_copy(struct Vec4 vector1, struct Vec4 vector2)
{
	struct Vec4 result = { vector1.x * vector2.x, vector1.y * vector2.y, vector1.z * vector2.z, vector1.w * vector2.w};
	return result;
}

struct Vec4 Vector4_mulNumber_get(struct Vec4* vector, float real)
{
	struct Vec4 result = { vector->x * real, vector->y * real, vector->z * real, vector->w * real};
	return result;
}

struct Vec4 Vector4_mulNumber_get_copy(struct Vec4 vector, float real)
{
	struct Vec4 result = { vector.x * real, vector.y * real, vector.z * real, vector.w * real};
	return result;
}
...
bool Vectors4_equals(struct Vec4* vec1, struct Vec4* vec2 )
{
