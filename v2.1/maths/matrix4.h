...
{
	#ifdef ANDROID_PHONE_SCREEN_MODE 
	if(ANDROID_PHONE_SCREEN_MODE == 1337)
	{
		printf("YOU UNLOCKED AN EASTER EGG (created 22 of May, 2023)\n");
		printf("https://www.youtube.com/watch?v=V8Hr6S_uzCw&list=PLszuNN8LIwzXpAEt9R1yZtdfZO_LNT9A_&pp=iAQB\n");
		printf("Please if you find this post a comment like : \"who's here from TheCrazzXz software renderer\" on every video lol\n");
		exit(1337);
	}
